...
def main():
    ...
    with open('collection.yaml', 'r', encoding='utf8') as f:
        yaml = YAML()
        yaml.preserve_quotes = True
        manifest_data = yaml.load(f)
    
    dl4miceverywhere_notebooks_path = '../DL4MicEverywhere/notebooks/Bespoke_notebooks'
    ...
    with open('collection.yaml', 'w', encoding='utf8') as f:
        yaml = YAML()
        yaml.preserve_quotes = True
